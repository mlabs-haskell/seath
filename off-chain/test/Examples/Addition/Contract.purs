...
import Seath.Test.Examples.Addition.Validator
  ( validatorScript
  )
...
instance
  DatumType AdditionValidator
    AdditionDatum

instance
  RedeemerType AdditionValidator
    AdditionRedeemer

newtype ActionNumber =
  ActionNumber
    Int
    ...
    case
      ...
      Nothing ->
        liftEffect
          $
            throw
              "Can't consume plutip configuration"
  where
